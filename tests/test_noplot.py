...
from src.noplot.story import world, story
from src.noplot.config import THEMES, MOTIFS


_FILENAME = "noplot.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "no plot project")
    ...
    def test_has_basic_infos(self):
        utl.exists_basic_infos_by_data(self,
                [
                    ("story", self.story, self.w.ayame, self.w.dazai),
                ])
