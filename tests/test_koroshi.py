# -*- coding: utf-8 -*-
"""Test: re_isekai_koroshi
"""
import unittest
from storybuilder.builder import testutils as utl
from src.isekoro.story import world, story, story_baseinfo, story_outline
from src.isekoro.config import THEMES, MOTIFS


_FILENAME = "isekoro.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "re_isekai_koroshi project")
    ...
    def test_has_basic_infos(self):
        utl.exists_basic_infos_by_data(self, story_baseinfo(w))

    def test_has_outline_infos(self):
        w = self.w
        utl.exists_outline_infos_by_data(self, story_outline(w))
