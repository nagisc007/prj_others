...
from src.pants.story import world, story, story_baseinfo, story_outline
from src.pants.config import THEMES, MOTIFS


_FILENAME = "pants.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The pants project")
