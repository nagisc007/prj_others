...
from src.yunow.story import world, story, story_baseinfo, story_outline
from src.yunow.config import THEMES, MOTIFS


_FILENAME = "yunow.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "Yusha now project")
