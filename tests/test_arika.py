# -*- coding: utf-8 -*-
"""Test: The whereabouts
"""
import unittest
from storybuilder.builder import testutils as utl
from src.arika.story import world, story, story_baseinfo, story_outline
from src.arika.config import THEMES, MOTIFS


_FILENAME = "arika.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The whereabouts project")
