...
def sc_letsbuying(w: wd.World):
    ...
    return w.scene("さて買い物だ",
            ...
            sol.talk("地図だけはなるべく最新のものを手に入れるようにするんだ。でないとまずいことになる"),
            yusha.talk("他には野宿用に簡易のテント設備とかも欲しいな。あ、でっかいリュックとかいるのか"),
            sol.talk("シートさえ敷けばそこら辺で寝ればいい"),
            mako.talk("あんたらまさか$meに地べたで星空見ながら寝ろっていうの！？"),
            yusha.talk("それが冒険の醍醐味ってやつじゃないのか？"),
            h.look("信じられない", "という顔で二人を見ている"),
            mako.talk("いいよ。$meだけは最新式の寝袋とテント備えるから"),
            h.move("自分で見るからいいよ、と一人だけで彼女は行ってしまった"),
            h.look("互いの顔を見合わせる男子二人。全く女ってやつはどうしてこう面倒なんだ、とでも言わんばかりだ"),
            h.look("アウトドア用品店を覗く"),
            h.look("立派な誂えの簡易テント。軽い素材で造られた支柱と丈夫に金属繊維を入れて編み込まれた布。その組み合わせの最新式は十万、十五万という数字が並んでいる"),
            sol.talk("こりゃテントは無理だ。", "全員寝袋だな"),
            h.look("しかし寝袋も五千Ｇ台。もう少し安いものもあったが、$solに言わせるとすぐに破れるそうだ"),
            sol.talk("ま、遠足にでも行く程度ならいいんだがな"),
            sol.talk("基本的にその時だけ必要なものは都度購入した方がいい。なるべく軽装の方が動きやすいし……一番困るのが盗賊や山賊被害だ。雪山で買ったばかりの寝袋ごと盗まれた時はマジで死ぬかと思ったぞ"),
            yusha.talk("それはお前がマヌケだっただけじゃないのか？"),
            sol.talk("おめぇは何も知らないなあ。モンスターだって盗んでいくんだよ。最近じゃ盗難被害の八割はモンスターだっつー話だぞ"),
            yusha.talk("何だって……"),
            h.look("続いて見て回ったのは金物屋。$solが言うには万能ナイフが大事らしい"),
            sol.talk("戦う武器もそうだが", "旅ってのは色々と自作することになる。そうすると万能ナイフ一本あれば簡単な調理までできていいんだよ"),
            yusha.talk("お前って……料理とかできたのか"),
            sol.talk("驚くとこソコかよ！"),
            h.look("だが多機能ナイフは結構高い。武器も欲しかった$Sは「後回しにしようぜ」と購入を回避した"),
            h.deal("他にもロープや小型の鍋、着火装置などの細々としたものを見て回ったが",
                "一つ一つは少額でも全部揃えるとなると手持ちの資金では足りなそうだった"),
            )
...
def sc_discounting(w: wd.World):
    ...
    return w.scene("安く揃えようぜ",
            ...
            h.move("そこに$n_makoが帰ってくる。彼女の手には小さなピンク色をした袋が握られている"),
            sol.talk("お？　お嬢は買い物してきたんだな"),
            mako.talk("当然でしょ。あ、でもこれは化粧道具とか、そういった小物で、別に旅の準備じゃないけど"),
            yusha.talk("え……$makoさん？"),
            mako.talk("だって必要になったら$st_amazonで頼めばどこだって配達してもらえるもの。とりあえず旅行用の服とか日焼けしないようなパラソルとか、そっちの方が大事でしょ？"),
            ...
            h.look("そこは$otokudotcomというサービスで",
                "各店舗の価格比較がなされていて一番安い店を選ぶことができるのだ"),
            sol.talk("おい、ここ安っ！", "嘘だろ？", "$healdrinkまとめ買い一ケースで千Ｇとか特売の時でも見ないぞ"),
            h.look("$solは歓喜している"),
            mako.talk("買い物というのは安くても構わないものならこういうとこを利用して揃えるといいのよ。逆にちゃんと大事にしたいもの、長く使いたいものはしっかりしたお店でお金を出して買うようにした方がいいけどね"),
            sol.talk("この店の万能ナイフ安すぎだろ……ちょっと買ってくる！"),
            h.look("$solは飛び出ていってしまった"),
            yusha.talk("これを参考に、揃えてみるよ。ありがとうな、$mako"),
            mako.talk("$taro……。",
                "$meはただ$taroのお役に立てればと思っただけで、そんな風に褒めてもらおうとか一ミリも思ってなくて、あ、でも$taroにお褒めの言葉をいただくのは気分が悪くないのでもっと言ってもらってもいいんですよ……あれ？　$taro？"),
            h.deal("既に$Sも部屋を出ていってしまっていた"),
            mako.talk("もう！"),
            h.think("しかし$Sたちは知らなかった。安物買いの銭失いという格言を大昔の人が残してくれていることを"),
            )
