...
def sc_maodistress(w: wd.World):
    ...
    return w.scene("魔王の苦悩",
            ...
            mane.ask("その件に関しては前も言ったように",
                "強い者と弱い者を同居させるとやつら弱い者虐めを始めて",
                "すぐに軍としての機能を喪失するから", "仕方なく何とかギリギリ指令通りに動けるような編成にしてあるのだ。",
            ...
            buka.talk("我々幹部の$phoneですが", "旧型故に最近固まったまま動かなくなることも増えてまいりまして。",
                "できましたら最近のＳ８にしていただけるとありがたいなと"),
            mane.ask("よく聞こえなかったんだが"),
            h.look("そう言って$n_manekoは部下にその視線を向ける。",
                "切れ長の瞳の中央が開き", "そこから黄金の眼が射抜くような眼光を放っていた"),
