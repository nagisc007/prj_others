...
def sc_takeainn(w: wd.World):
    ...
    return w.scene("勇者宿をとる",
            ...
            h.deal("宿。",
                ...
                "のはずだ"),
            yusha.talk("お、おう……"),
            h.look("$Sである少年はあばら屋と呼んでも差し支えない実に見事な木と布の集合作品を見て",
                "言葉にならない声を漏らす"),
            ...
            h.look("明らかに壁に穴が開いているのを見ながら老婆はそう言う。",
                "それを$Sの隣で見ながら小さく苦笑したのはピンクのおかっぱ頭の$n_makoだ。",
            ...
            h.look("彼女に悪びれた様子はない"),
            sol.talk("いやだって$meたちお嬢に驕ってもらっても将来的に返せる当てねえぞ？"),
