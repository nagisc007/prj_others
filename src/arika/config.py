...
CHARAS = (
        # main
        ("mio", "夏草,美緒", 17, "female", "学生",
            "me:わたし:S:わたし:asano:右輪さん:asachi:麻乃さん:inaba:稲葉さん:haru:春彦さん:yamane:山根さん:ochi:越智さん"),
        # sub
        ...
        # family
        ("mam", "夏草,明美", 42, "female", "パート", "me:私:mio:美緒"),
        ("dad", "夏草,芳正", 43, "male", "会社員", "me:僕:mio:美緒"),
