...
CHARAS = (
        ...
        # sub
        ("robber", "ストッキング,三郎", 42, "male", "ストッキング", "me:ワシ"),
...
INFOS = (
        ...
        ("herword008", "あなたはいつもパンツとひと括りにするけれど形状から目的から材質や歴史的な経緯。そこにはデザイナーの魂から絞り出された名があるの。何でもパンツと言わないで"),
        ("herword009", "ストッキングは確かに大切よ。保温と共に脚を美しく見せてくれる最強の武器の一つだもの。けどね、パンツとは折り合いが悪いの。ストッキングは飽くまで脚の為の存在だから"),
        )
